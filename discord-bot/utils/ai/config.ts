...
export interface NvidiaConfig {
  ...
  visionModel: string;
  imageModel: string;
  imageModels: string[]; // quality -> fallback chain
...
const DEFAULT_IMAGE = 'black-forest-labs/flux.2-klein-4b,black-forest-labs/flux.1-dev';
...
export function getConfig(): NvidiaConfig {
  ...
  return {
    ...
    imageModel: csv(process.env.NVIDIA_IMAGE_MODEL, DEFAULT_IMAGE)[0],
    imageModels: csv(process.env.NVIDIA_IMAGE_MODEL, DEFAULT_IMAGE),
