...
function buildTimeParserPrompt(userInput) {
...
const IMAGINAR_NEGATIVE_PROMPT = 'blurry, distorted, low quality, deformed, ugly';

module.exports = { SIMSIMI_SYSTEM, SHERLOCK_SYSTEM, buildTimeParserPrompt, IMAGINAR_NEGATIVE_PROMPT };
